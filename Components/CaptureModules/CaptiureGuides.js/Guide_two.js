...
function Guide_two({ visible, onClose }) {
  return (
    <Modal
      animationType="fade"
      transparent={true}
        ...
        <View style={styles.modalContent}>
          ...
          <View style={styles.guideContainer}>
            <View style={styles.guideItem}>
              ...
              <Text style={styles.guideText}>Keep the mobile in centerr</Text>
            </View>

            <View style={styles.guideItem}>
              <Ionicons name="arrow-forward-circle-outline" size={30} color="#FE6D2B" />
              <Text style={styles.guideText}>Move to the right for capturing more images!</Text>
            </View>

            <View style={styles.guideItem}>
              <Ionicons name="images-outline" size={30} color="#FE6D2B" />
              <Text style={styles.guideText}>Please click multiple images if required</Text>
            </View>
          </View>
